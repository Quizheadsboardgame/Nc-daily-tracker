...
import { Banknote, CreditCard, Receipt, TrendingUp, DollarSign } from 'lucide-react';
import { DaySummary, PaymentMethod } from '../types';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center gap-1.5 mt-1.5 text-xs text-zinc-400 font-medium flex-wrap">
              ...
              <span>
                ...
                {summary.totalCount === 1 ? 'sale' : 'sales'} recorded today
              </span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-3">
            ...
            >
              {cashPct.toFixed(1)}% of sales volume
            </div>
          </div>
        </button>
        ...
        >
          ...
          <div className="mt-3">
            ...
            >
              {cardPct.toFixed(1)}% of sales volume
            </div>
          </div>
        </button>
        ...
        <div className="bg-white rounded-2xl border border-zinc-300 p-4 sm:p-5 shadow-xs relative overflow-hidden">
          ...
          <div className="mt-3">
            <div className="text-2xl sm:text-3xl font-black tracking-tight text-zinc-950 tabular-nums break-words">
              {formatCurrency(summary.averageTicket)}
            </div>
            <div className="flex items-center gap-1.5 mt-1.5 text-xs text-zinc-500 font-medium">
              <span>Avg spend per customer sale</span>
            </div>
          </div>
        </div>
      </div>
